...
<div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="logout.php">LOG OUT</a></h5>
                ...
                <a href="overview.php"><button class="btn btn-primary">University Ranking</button></a>
                <a href="overviewA.php"><button class="btn btn-default" >University Indicators</button></a>
                <a href="overview2.php"><button class="btn btn-default"  >Search by University</button></a>
	 <form method="POST" name="search" action="overview.php">
        <div id="demo-grid">
