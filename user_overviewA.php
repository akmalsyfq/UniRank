...
<div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="user_logout.php">LOG OUT</a></h5>
                ...
                <a href="user_overview.php"><button class="btn btn-dafault">University Ranking</button></a>
                <a href="user_overviewA.php"><button class="btn btn-primary" >University Indicators</button></a>
                <a href="user_overview2.php"><button class="btn btn-default"  >Search by University</button></a>

	 <form method="POST" name="search" action="user_overviewA.php">
        <div id="demo-grid">
