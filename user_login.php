...
<h3>E-RANKING MANAGEMENT SYSTEM</h3>
	...
	<div class="radio-toolbar">
				 <input type="checkbox" id="radioApple" name="radioFruit" value="user" checked>
				 <label for="radioApple">User</label>
		...
		<p>
			Not yet a member? <a href="user_register_new.php">Sign up</a>
		</p>
