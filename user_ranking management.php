...
<div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="index2.php?logout='1'">LOG OUT</a></h5>
    </div>
</div>
  </div>
  ...
  <button style="margin-right:20%; margin-top:4%" ><a href="user_ranking management2.php" class="button2" >Add Uni</a></button>
 ...
 <table cellpadding="30" cellspacing="1" style="margin-top:-5%;padding-top:20px">
	...
	<?php while ($row = mysqli_fetch_array($results)) { ?>
		<tr>
			...
			<td>
				<a href="user_edit.php?edit=<?php echo $row['id']; ?>" class="edit_btn" >Edit</a>
			</td>
			<td>
